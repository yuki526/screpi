...
<br><br>
 ...
 ・ページによってお買物リストの幅が変わってしまう課題の解決
 ・スマホ、タブレットからでも使いやすく表示するためのレスポンシブルデザイン  
 ・TravisCIと連携時、単体テストは通るが結合テストが一部うまく実施できていない。  
 　→seleniumのコンテナとアプリのコンテナの連携がうまくできていない、という仮説を元に引き続き調査中  
 　→(1/7)circleCIでの設定に変えたところ、successのステータスにはなるがDBのセットアップができていない状態のため調整をすすめる  
 ...
 リッチテキスト形式（ActionText）導入により生成されるテーブルの詳細をブログ記事にまとめました。  
 https://ykpg.hatenadiary.com/entry/2021/01/02/202202  
